...
# array of locations
locations = ["USACanada", "SouthAmerica", "Europe", "India", "China", "JapanKorea", "SoutheastAsia", "Oceania", "CentralAmerica", "Africa"]
	...
	<mcmc id="mcmc" chainLength="12000000" autoOptimize="true" operatorAnalysis="#{analysis}.ops">
		<posterior id="posterior">
			<prior id="prior">
				...
				<exponentialPrior mean="#{location_count}" offset="0">
